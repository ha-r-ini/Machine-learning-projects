...
if fileneme is None:
    ...
    inpimg = mpimg.imread(fileneme)
    plt.imshow(inpimg)
    plt.title('Original Image')
    plt.axis ('off')
    plt.show()
    
    st.image(inpimg,caption="Original Image")
    ...
    st.image(img_resize_orig,caption="Resize Image")   
    ...
    plt.title("LBP")
    plt.show()
    st.image(img_lbp,caption ="lbp image")  
    ...
    if labels1[zz[0][0]] == 0:
        ...
        st.write('--------------------------')
        print()
        st.write('Identified = Strawberry')   
        print()
        st.write('-------------------------')       
        a='Strawberry'  
    ...
    data_frame1_gram=data_frame['Grams']    
    ...
    Req_data_gram=data_frame1_gram[idx]    
    ...
    st.write("----------------------------------------------------------------")
    st.write("================= PREDICTION FOR NUTRITION VALUES ==============")
    st.write("----------------------------------------------------------------")
    print()
    
    st.write("1.Carbohydrates value = ",Req_data_c )
    print()
    st.write("2.Fats value          = ",Req_data_fat)
    print()
    st.write("3.Fiber value         = ",Req_data_fib )
    print()
    st.write("4.Calorie value       = ",Req_data_cal)
    print()
    st.write("5.Protein value       = ",Req_data_p)
    
    
    
    aa ="Recommended Grams " + str(Req_data_gram)
    st.markdown(f'<h1 style="color:#000000;text-align: center;font-size:36px;">{aa}</h1>', unsafe_allow_html=True)

    
    
    import subprocess
    subprocess.run(['streamlit','run','Doctor.py'])
