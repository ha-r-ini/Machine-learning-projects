...
st.markdown(f'<h1 style="color:#000000;text-align: center;font-size:36px;">{"Nutrition analyzer and dietary choice recommendation system using deep learning"}</h1>', unsafe_allow_html=True)
